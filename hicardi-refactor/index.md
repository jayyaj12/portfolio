...
**한 줄 요약**  
단기 생산성보다 장기 운영 안정성과 예측 가능성을 우선한 결정이었습니다.

---

## 6. Interview Questions
- 왜 MVVM이 아니라 MVI를 선택했으며, 어떤 경우에 MVI가 과해질 수 있나요?
- 멀티모듈 분리 기준은 무엇이었고, 순환 의존성은 어떻게 방지했나요?
- 빌드 시간 78% 개선의 주요 병목은 어디였고, 어떻게 측정했나요?
- build-logic 도입 시 발생한 충돌 사례와 해결 방법은 무엇이었나요?
- 테스트 커버리지 60%의 범위와 의도적으로 제외한 영역은 무엇인가요?
